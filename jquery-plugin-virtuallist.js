/*!
 * jQuery lightweight plugin jqVirtuallist
 * Original author: @lsc
 */

;(function ( $, window, document, undefined ) {

  var pluginName = "jqVirtuallist"
  var defaults = {
    data: [],
    setCell: (row) => {
      return ''
  ...
  Plugin.prototype.init = function () {
    ...
    const s2 = '<div class="list" style="width: 100%;height: 100%;position: absolute;top: 0;left: 0;"></div>'
    // 外层盒子
